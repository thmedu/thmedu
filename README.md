<div style="display: flex; flex-direction: column; align-items: center;">
  ...
  <div style="display: inline_block;">
    <h3>Meus principais interesses e habilidades incluem:</h3>
    <img width="50" height="50" src="https://img.icons8.com/officel/80/php-logo.png" alt="PHP">
    <img width="50" height="50" src="https://img.icons8.com/3d-fluency/94/python.png" alt="Python">
    <img width="50" height="50" src="https://img.icons8.com/color/96/html-5--v2.png" alt="HTML5">
  ...
  <div style="display: inline_block;">
    <h3>Frameworks:</h3>
    <img width="40" height="40" src="https://img.icons8.com/arcade/64/000000/laravel.png" alt="Laravel">
    <img width="40" height="40" src="https://img.icons8.com/officel/80/react.png" alt="React">
    <img width="40" height="40" src="https://img.icons8.com/color/96/django.png" alt="Django">
    <img width="40" height="40" src="https://img.icons8.com/color/69/docker.png" alt="Docker">
    <img width="40" height="40" src="https://img.icons8.com/color/69/git.png" alt="Git">
    <img width="40" height="40" src="https://img.icons8.com/fluency/69/terraform.png" alt="Terraform">
    <img width="40" height="40" src="https://img.icons8.com/color/69/kubernetes.png" alt="Kubernetes">
    <img width="48" height="48" src="https://img.icons8.com/color/48/jenkins.png" alt="Jenkins">
    <img width="40" height="40" src="https://img.icons8.com/color/96/selenium-test-automation.png" alt="Selenium Test Automation">
  ...
  <div>
    ...
    <a href="https://www.instagram.com/thmeduardo/" target="_blank">
    ...
    <a href="https://outlook.live.com/mail/0/sentitem" target="_blank">
  ...
  <div>
    <h3>Indicações de livro:</h3>
    <img src="https://s3.novatec.com.br/capas/9788575228432.jpg" alt="Curso Intensivo de Python" style="width: 150px; height: 150px;">
    <img src="https://d2sofvawe08yqg.cloudfront.net/dockerparadesenvolvedores/s_hero2x?1620520440" alt="Docker para desenvolvedores" style="width: 150px; height: 150px;">
